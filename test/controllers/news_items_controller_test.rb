...
class NewsItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post news_items_url, params: { news_item: { content: @news_item.content, heading: @news_item.heading } }
    end
  ...
  test "should update news_item" do
    patch news_item_url(@news_item), params: { news_item: { content: @news_item.content, heading: @news_item.heading } }
